class CarMesh {
	constructor(x=0, y=0, z=0) {
		...
		var c1 = new CarSquare(mesh, matBody, extrSettings, 3, 5, 0, 0);
		var c2 = new CarSquare(mesh, matBody, extrSettings, 8, 3, 3, 2);
		var c3 = new CarSquare(mesh, matBody, extrSettings, 7, 2, 11, 0);
		var c4 = new CarSquare(mesh, matBody, extrSettings, 12, 6, 11, 2);
		var t1 = new CarTriangle(mesh, matBody, extrSettings, -2, 2.5, 0, 0, 2.5, 0, 0, 5, 0);
		var t2 = new CarTriangle(mesh, matBody, extrSettings, -2, 2.5, 0, 0, 0, 0, 0, 2.5, 0);
		var t3 = new CarTriangle(mesh, matBody, extrSettings, 3, 0, 0, 4, 2, 0, 3, 2, 0);
		var t4 = new CarTriangle(mesh, matBody, extrSettings, 9, 2, 0, 11, 0, 0, 11, 2, 0);
		var t5 = new CarTriangle(mesh, matBody, extrSettings, 8.5, 5, 0, 11, 5, 0, 11, 8, 0);
		var t6 = new CarTriangle(mesh, matBody, extrSettings, 18, 0, 0, 19, 2, 0, 18, 2, 0);
		var t7 = new CarTriangle(mesh, matBody, extrSettings, 22, 2, 0, 23, 0, 0, 23, 2, 0);
		var t8 = new CarTriangle(mesh, matBody, extrSettings, 23, 0, 0, 24, 5, 0, 23, 5, 0);
		var t9 = new CarTriangle(mesh, matBody, extrSettings, 23, 5, 0, 24, 5, 0, 23, 8, 0);
		//Creates the wheels.
		...
		//Creates the axles.
		var cy1 = new CarCylinder(mesh, materialAxle, 0.5, 12, 8, 1,  5.5,  -1, 4, 90, 0,  0);
		var cy2 = new CarCylinder(mesh, materialAxle, 0.5, 12, 8, 1, 20.5,  -1, 4, 90, 0,  0);
		var cy3 = new CarCylinder(mesh, materialAxle, 0.5,  3, 8, 1,  5.5, 0.5, 4,  0, 0,  0);
		var cy4 = new CarCylinder(mesh, materialAxle, 0.5,  3, 8, 1, 20.5, 0.5, 4,  0, 0,  0);
		var cy5 = new CarCylinder(mesh, materialAxle, 0.5, 15, 8, 1,    3,   9, 4,  0, 0, 90);
