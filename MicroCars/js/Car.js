class Car1 {
	constructor(x, y, z) {
		...
		var materialWheels = new THREE.MeshLambertMaterial({color:0xa0a0a0});
		var extrSettings = {amount:8, bevelEnabled:false};

		var c1 = new Car1Square(this.mesh, matBody, extrSettings, 5, 5, 0, 0)
		var c2 = new Car1Square(this.mesh, matBody, extrSettings, 6, 3, 5, 2);
		...
		var t3 = new Car1Triangle(this.mesh, matBody, extrSettings, 5, 0, 0, 6, 2, 0, 5, 2, 0);
		var t4 = new Car1Triangle(this.mesh, matBody, extrSettings, 10, 2, 0, 11, 0, 0, 11, 2, 0);
		...
		var w1 = new Car1Torus(this.mesh, materialWheels, 2.5, 0.6, 10, 16, 8, -1, 0);
		var w2 = new Car1Torus(this.mesh, materialWheels, 2.5, 0.6, 10, 16, 20.5, -1, 0);
		var w3 = new Car1Torus(this.mesh, materialWheels, 2.5, 0.6, 10, 16, 8, -1, 9);
		var w4 = new Car1Torus(this.mesh, materialWheels, 2.5, 0.6, 10, 16, 20.5, -1, 9);
...
class Car1Square {
	constructor(obj, material, extrSettings, cubeL1, cubeL2, x, y) {
		...
		obj.add(new THREE.Mesh(extrudeGeometry, material));
...
class Car1Torus {
	constructor(obj, material, radius, tube, rSeg, tSeg, x, y, z) {
		var geometry = new THREE.TorusGeometry(radius, tube+0.5, rSeg, tSeg);
		var mesh = new THREE.Mesh(geometry, material);
